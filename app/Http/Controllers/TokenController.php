...
class TokenController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            //📌 Ajout fait avec l'IA :vérifie que les permissions choisies existent vraiment. 
            'scopes.*' => 'string|in:posts:read,posts:create,posts:update,posts:delete,routines:read,routines:create,routines:update,routines:delete',
            //📌 Ajout fait avec l'IA : Ajout fait avec l'IA :
